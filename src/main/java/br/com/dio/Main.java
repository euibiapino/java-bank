...
public class Main {
    ...
    private static void createInvestment () {
        ...
        System.out.println("Informe o valor inicial de depósito: ");
        var initialFunds = scanner.nextInt();
    ...
    private static void deposit () {
        System.out.println("Informe a cahve pix da conta para depósito: ");
        var pix = scanner.next();
    ...
    private static void transferToAccount () {
        System.out.println("Informe a cahve pix da conta de origem: ");
        var source = scanner.next();
        System.out.println("Informe a cahve pix da conta de destino: ");
    ...
    private static void createWalletInvestment () {
        System.out.println("Informe a cahve pix da conta: ");
        var pix = scanner.next();
        var account = accountRepository.findByPix(pix);
        System.out.println("Informe o identificador do ivestimento: ");
        var investmentId = scanner.nextInt();
        var investimentWallet = investmentRepository.initInvestment(account, investmentId);
        System.out.println("Conta de investimento craida: " + investimentWallet);
    }

    private static void incInvestment(){
        System.out.println("Informe a cahve pix da conta para investimento: ");
        var pix = scanner.next();
